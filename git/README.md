...
branch name already exists. This will _not_ switch to the newly created branch. To track a remote branch _and_ switch to it, issue: `git checkout -b <local> --track origin/<remote>`.
